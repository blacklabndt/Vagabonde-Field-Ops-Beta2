-- FILED FROM LIVE HISTORY, 13 Sept 2026. This is APPLIED: it is recorded in
-- supabase_migrations.schema_migrations on project eielmvxzdwwprmmfamlq, and
-- this text is that recorded statement verbatim. The "DRAFT, NOT APPLIED"
-- header below is the draft's own wording, kept as applied; it is no longer
-- true. Do not reapply.
--
